...
import djfritz_ynh
from djfritz_ynh.cli_dev import app
...
def install():
    """
    Install requirements and 'djfritz_ynh' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=djfritz_ynh, package_path=get_project_root())
